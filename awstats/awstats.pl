...
sub Read_Config {
	...
	# Standard, Mandrake and Debian package :	"/home/yartist2022/domains/sales-support.y-artist.work/awstats/.data"
	# Other possible directories :				"/usr/local/etc/awstats", "/etc"
	# FHS standard, Suse package : 				"/etc/opt/awstats"
	my $configdir         = shift;
	my @PossibleConfigDir = (
			"$DIR",
			"/home/yartist2022/domains/sales-support.y-artist.work/awstats/.data",
